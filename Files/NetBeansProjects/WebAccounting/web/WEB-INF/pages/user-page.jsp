                                ...
                                <form method="post">
                                    ...
                                    <table border="1">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Amount</td>
                                                <td><input type="text" name="amount" placeholder="On you account ${totalAmount}$" value="<c:out value="${editSample.amount}" />" min="1" max="2147483647" required /></td>
                                            </tr>
                                            <tr>
                                                <c:choose>
