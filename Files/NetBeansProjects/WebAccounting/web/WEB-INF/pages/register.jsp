                            ...
                            <td rowspan="4" width="600" bgcolor="e6e6fa"> 
                                <form method="post">
                                    <div class="input-group">
                                        Create new login: <input type="text" name="created login" required="required">
                                    </div>
                                    <div class="input-group">
                                        Create new password: <input type="password" name="created password" maxlength='20' required minlength='5'>
                                    </div>
