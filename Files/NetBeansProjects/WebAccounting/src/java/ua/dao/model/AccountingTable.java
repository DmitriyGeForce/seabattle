...
public class AccountingTable implements Serializable {
    ...
    public AccountingTable(int amount, String dateOfAction, String typeOfAction) {
        this.amount = amount;
        this.dateOfAction = dateOfAction;
        this.typeOfAction = typeOfAction;
    }

    public AccountingTable(int amount, Integer accountingTableId, String typeOfAction) {
        this.amount = amount;
    ...
    public String toString() {
        return "ua.dao.model.AccountingTable[ accountingTableId=" + accountingTableId + " ]";
    }
